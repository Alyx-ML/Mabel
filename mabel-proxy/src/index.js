...
export default {
  async fetch(request, env) {
    ...
    try {
      ...
      const result = await env.AI.run(MODEL,{messages:[{role:"system",content:SYSTEM_PROMPT},...clean],chat_template_kwargs:{enable_thinking:false},max_tokens:400,temperature:0.8});
